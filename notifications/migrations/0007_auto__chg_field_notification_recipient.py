...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'notifications_notification', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[auth_user_model_label]))

    def backwards(self, orm):

        # Changing field 'Notification.recipient'
        db.alter_column(u'notifications_notification', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications'", 'to': "orm['%s']" % auth_user_model_label}),
